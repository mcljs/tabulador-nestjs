...
export class Tabuladorelacion1707225248640 implements MigrationInterface {
    name = 'Tabuladorelacion1707225248640'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "envio_entity" ("id" SERIAL NOT NULL, "distancia" integer NOT NULL, "peso" integer, "valor_declarado" double precision NOT NULL, "flete" double precision NOT NULL, "proteccion_encomienda" double precision NOT NULL, "subtotal" double precision NOT NULL, "iva" double precision NOT NULL, "franqueo_postal" double precision NOT NULL, "total_a_pagar" double precision NOT NULL, "tracking_number" character varying NOT NULL, "status" character varying NOT NULL, "rute_initial" character varying, "rute_finish" character varying, "tipo_articulo" character varying NOT NULL, "costo_total" double precision NOT NULL, "user_id" uuid, CONSTRAINT "PK_c4a2d6487e7a24abc5f52264d4c" PRIMARY KEY ("id"))`);
