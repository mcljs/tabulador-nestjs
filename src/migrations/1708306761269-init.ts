...
export class Init1708306761269 implements MigrationInterface {
    name = 'Init1708306761269'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "configuracion" ("id" SERIAL NOT NULL, "costo_por_km" double precision NOT NULL, "costo_gasolina" double precision NOT NULL, "porcentaje_proteccion" double precision NOT NULL, "proteccion_minima" double precision NOT NULL, "franqueo_postal" double precision NOT NULL, CONSTRAINT "PK_42615c5e55d08746ae5accfc295" PRIMARY KEY ("id"))`);
